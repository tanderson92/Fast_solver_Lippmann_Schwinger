...
nu(x,y) = ( 0.2*exp(-20*(x.^2 + y.^2))  + 0.25*exp(-200*((x - 0.1).^2 + (y+0.1).^2)) +
            ...
            0.25*exp(-200*((x+0.2).^2 + (y+0.2).^2))  + 0.2*exp(-1000*(2*(x-0.1).^2 + (y+0.2).^2)) +
            0.037*exp(-200*( (x+0.23).^2 +   (y-0.30).^2))  + 0.308*exp(-1000*(  (x-0.274).^2 + (y-0.24).^2)) +
            ...
            0.140*exp(-2000*((x-0.36).^2 + 3*(y+0.10).^2))  + 0.105*exp(-100*(   (x-0.234).^2 + (y+0.4).^2)) +
            0.048*exp(-200*( (x+0.32).^2 +   (y+0.45).^2))  + 0.258*exp(-1000*(2*(x-0.051).^2 + (y-0.2).^2)) +
            0.037*exp(-200*( (x-0.23).^2 +   (y+0.30).^2))  + 0.308*exp(-1000*(  (x+0.274).^2 + (y+0.24).^2)) +
            0.050*exp(-200*( (x+0.08).^2 +   (y-0.23).^2))  + 0.233*exp(-100*(   (x+0.204).^2 + (y+0.24).^2)) +
            0.021*exp(-1000*((x+0.37).^2 + 2*(y+0.29).^2)) +  0.299*exp(-1000*(  (x+0.124).^2 + (y-0.04).^2)) +
            0.140*exp(-2000*((x+0.36).^2 + 3*(y-0.10).^2))  + 0.105*exp(-100*(   (x+0.234).^2 + (y-0.4).^2)) +
